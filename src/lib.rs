...
mod tests {
    ...
    #[test]
    fn test_inv_s_box_layer() {
        let state = 0b1100010101101011100100001010110100111110111110000100011100010010u64;
        let new_state = inv_s_box_layer(state);

        let expected = 0b0000000100100011010001010110011110001001101010111100110111101111u64;
        assert_eq!(expected, new_state);
    }
